---
date: 2026-04-24
tags: [squad-dollar, skool, paperclip, governanca, orgchart, bonus-entregavel]
project: runa-systems-global
type: course-support
produto: [[squad-dollar-prd]]
modulo: "Bônus — Entregável Extra da Mentoria"
nota: Paperclip foi removido da infraestrutura interna. Entregue no último dia como opção de gestão visual do squad para o cliente.
---

# Bônus — A Empresa Que Se Governa (Paperclip)

> Entregável Extra · Último dia da mentoria

Este é um entregável opcional entregue no encerramento. Após construir todos os agentes do squad, o Paperclip oferece uma camada de governança visual: organograma, heartbeats automáticos, controle de orçamento e metas. É uma opção para quem quer gerenciar o squad de forma estruturada via interface visual, sem depender só do terminal.

**Contexto:** a infraestrutura da Runa não usa Paperclip internamente — o AIOX resolve isso de forma mais robusta. O Paperclip aqui é um entregável para o cliente que prefere uma visão organizacional clara do seu squad.
...
- [ ] Todos os arquivos YAML dos módulos 2-6 finalizados e testados
...
Este é o passo mais longo — você vai importar o contexto de cada agente dos módulos anteriores para o Paperclip.

### Para cada agente:
1. Abra o arquivo YAML do agente em `agents/` (ex: `agents/agente-oferta.md`)
2. Copie o bloco `persona.identity` — esse é o contexto do negócio que o agente carrega
...
- [ ] Todos os arquivos YAML importados para `.paperclip/agents/`

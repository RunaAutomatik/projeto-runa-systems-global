---
date: 2026-04-08
tags: [products, catalog, runa-systems, teia, offers]
project: runa-systems-global
status: canonical — v2 (2026-04-08)
type: source-of-truth
updated-by: ORION (pricing audit 2026-04-08)
---
# Runa Systems Global — Product Catalog

> Source of truth for all products, their status, and their role in the teia.
> Connected: [[squad-architecture]] | [[ares]] | [[freyja]] | [[runa-systems-business-context]]
> **v2 (2026-04-08):** Pricing canonicalized, deprecated brands archived, POSICIONAMENTO$ consolidated, AGENTE$ renamed AGENT$.
> See: [[positioning-audit-2026-04-08]] for full change rationale.

---

## The Core Logic

**Products sell knowledge. Services generate cases. Cases become knowledge products.**

Arthur doesn't sell sites. He sells the knowledge of how to build a site with AI in 21 days.
The site built for a client is the case. The process documented is the product.

Every product in this catalog was (or will be) built for real first.
...
```
LOW TICKET (R$97–297)               MID TICKET (R$197–2.997)            HIGH TICKET (R$15k–50k)
─────────────────────               ────────────────────────            ───────────────────────
ORÇAMENTO$  R$97–197                CREATOR$        R$997               RUNA SYSTEMS R$15k/ano
Lives       R$97                    MIND$           R$997               RUNA MENTORIA R$30k
Kit Avatar  R$97 (aperitivo)        POSICIONAMENTO$ R$997               RUNA INTERVENÇÃO R$50k
                                    PRODUTIZADO$    TBD
                                    SITE$           R$197–297
                                    AGENT$          R$1.997
                                    $QUAD           R$2.997
...
> NOTE: ALPHA®, MAYA®, ICARUS® are fully deprecated — see archived section at the bottom of this file.
> Alpha® is the demo case/persona for CREATOR$, NOT a product tier.

**Avatar IP Stack (in sequence):** CREATOR$ → MIND$ → POSICIONAMENTO$ → PRODUTIZADO$ → $QUAD → RUNA SYSTEMS
...
### ORÇAMENTO$ *(next to build)*
**Status:** Concept → in development
**What it is:** How to present proposals and budgets as hyperpersonalized interactive LPs that increase conversion and closing rates.
...
**What it is:** How to create a consistent AI-generated visual avatar (fictional character or the expert themselves) — images + videos + storyboard as the permanent creative foundation.
**Core promise:** Create your avatar. Own your narrative. Appear without appearing.
**Boundary:** Visual identity only. NOT: system prompts (MIND$), content scripts (POSICIONAMENTO$), monetization (PRODUTIZADO$).
**Method:** Nano Banana 2 → Higgsfield → Sora 2. LENS agent for image prompts, REEL agent for video prompts.
...
**Boundary:** IP architecture + system prompt + avatar training. NOT visual identity (CREATOR$).
...
**What it is:** How to turn the trained avatar into a content machine — scripts, formats, pipeline, and organic authority. Content without the founder's constant presence.
**Core promise:** Organic authority. Sales letters disguised as posts. Pipeline that runs without you.
**Boundary:** Scripts, content formats, posting pipeline. NOT visual identity (CREATOR$) or IP extraction (MIND$).
...
**Boundary:** Monetization of avatar. The Alpha® teia (CREATOR$ + MIND$ + POSICIONAMENTO$ + PRODUTIZADO$) = full IP business.
**Format:** TBD
**Price:** TBD
**Upsell to:** $QUAD → RUNA SYSTEMS
...
**Price:** R$197–297 · No launch discount
...
### AGENT$ *(planned)*
**Status:** Concept
**What it is:** How to create neural agents and tool agents — convert expertise into money.
**Core promise:** Your knowledge = scalable product. One agent, infinite clients.
**Format:** Mini-course + build-along + templates
**Price:** R$1.997 · Launch: R$997–1.398 (30–50% off)
**Upsell to:** $QUAD → RUNA SYSTEMS
**Agent responsible:** ORION documents the build process + FREYJA sells it
...
**Price:** R$2.997 · Launch: R$1.497–2.098 (30–50% off)
...
## Upsell Map (ARES manages this)

```
ORÇAMENTO$       → $QUAD, POSICIONAMENTO$
CREATOR$         → MIND$ → POSICIONAMENTO$ → PRODUTIZADO$ → $QUAD → RUNA SYSTEMS
MIND$            → POSICIONAMENTO$ → $QUAD → RUNA SYSTEMS
POSICIONAMENTO$  → $QUAD → RUNA SYSTEMS
AGENT$           → $QUAD → RUNA SYSTEMS
...
*Last updated: 2026-04-08 | Updated by: ORION | See: [[positioning-audit-2026-04-08]]*

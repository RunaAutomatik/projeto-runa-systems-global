---
date: 2026-04-10
tags: [runa-systems, skool, claude-code, principios, conceitos, modulo-claude-code]
project: runa-systems-global
type: course-support
produto: [[runa-systems-prd]]
modulo: "Módulo Claude Code · Aula 1.2 — Princípios Básicos"
---
...
1. **Capacidade:** a janela de contexto tem um limite em tokens (ex: 200k tokens no Sonnet)
2. **Custo:** você paga por tokens usados — tanto os de entrada (input) quanto os de saída (output)
...
1. Você cria um arquivo `.md` dentro de `.claude/commands/` (ou `~/.claude/commands/` para uso global)
2. O conteúdo desse arquivo é o prompt que será executado
3. Para usar: `/nome-do-comando`
...
1. O agente pai recebe a tarefa grande
2. Cria um subagent para a parte de pesquisa
3. O subagent faz a pesquisa em contexto isolado
4. Retorna apenas o resultado para o pai
5. O pai cria outro subagent para a parte de implementação

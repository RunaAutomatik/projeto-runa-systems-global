---
date: 2026-04-10
tags: [runa-systems, skool, claude-code, instalacao, setup, modulo-claude-code]
project: runa-systems-global
type: course-support
produto: [[runa-systems-prd]]
modulo: "Módulo Claude Code · Aula 1.1 — Instalação e Configuração"
---
...
1. Feche o Claude Desktop App (competem pelo mesmo socket)
2. Delete `~/.claude/auth.json`
3. Rode `claude` novamente para reautenticar

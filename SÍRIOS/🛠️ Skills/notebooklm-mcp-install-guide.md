---
date: 2026-04-15
tags: [notebooklm, mcp, claude-code, instalação, guia, tools]
...
| Autenticação expirada | Cookies ~2-4 semanas | Rodar `nlm login` novamente |
...
- SDK Python alternativo: `https://github.com/teng-lin/notebooklm-py`

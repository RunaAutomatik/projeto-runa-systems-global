...
- **Primeiro squad recomendado:** Criação (Copy + Design + Video + Calendar + Brand Agents)

---

## Histórico de Sessões

| Sessão | Tema | Data | Status | Escopo |
|--------|------|------|--------|--------|
| Sessão 01 | Mapeamento + Business Mapping | 2026-04 | ✅ Realizada | [[📋 escopos-de-aula/runa-intervencao-sessao-01-lucas-pesto]] |
| Sessão 02 | Automação de Conteúdo (Carrosséis, Posts, Reels) | TBD | 🔄 Planejando | — |
...
→ **Sessão 02:** Automação de Conteúdo — Carrosséis, Posts, Reels

<!-- converted from claude-code-03-skills-plugins-mcps-clis.docx -->
...
- Slash commands — atalhos de prompt com /nome
- Hooks — automações disparadas por eventos (veja aula 1.2, conceito 16)
### Slash Commands
...
- Tools nativas do Claude Code (Read, Write, Edit, Bash, Glob, Grep) — sempre primeiro
- Skills do projeto (.claude/skills/) — instruções especializadas
- Skills globais (~/.claude/skills/) — capacidades reutilizáveis
- MCPs — quando precisa de um serviço externo
- CLIs via Bash — quando o MCP não existe mas há uma ferramenta de terminal

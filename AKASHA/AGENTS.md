...
- `wiki/concepts/` — abstract ideas, frameworks, techniques.
- `wiki/sources/` — source summary pages.
- `wiki/analyses/` — comparisons, syntheses, audits.
- `wiki/index.md` — catalog of every page. Read this first on any query.
- `wiki/log.md` — append-only operation log.
- `wiki/hot.md` — 500-char rolling buffer of recent active knowledge.
